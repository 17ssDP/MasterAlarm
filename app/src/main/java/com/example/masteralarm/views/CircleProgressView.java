...
public class CircleProgressView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.CircleProgressView_radius, 200);
        mRadius = 200;
        mStrokeWidth = typeArray.getDimension(R.styleable.CircleProgressView_strokeWidth, 20);
        mCircleColor = typeArray.getColor(R.styleable.CircleProgressView_circleColor, 0xFFFFFFFF);
        mRingColor = typeArray.getColor(R.styleable.CircleProgressView_ringColor, 0xFFFFFFFF);
        mRingBgColor = typeArray.getColor(R.styleable.CircleProgressView_ringBgColor, 0xFFFFFFFF);
